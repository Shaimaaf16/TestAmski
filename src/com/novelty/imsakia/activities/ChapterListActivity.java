...
//import com.app.amskia.R;
//import com.imskyaa.database.QuranDAO;
//import com.imskyaa.model.SurahAndChapterModel;
//import com.imskyaa.ui.adapters.QuraanListAdapter;
//import com.imskyaa.utils.Params;
/**
 * 
 * @author M.Turki
 *
...
public class ChapterListActivity extends Activity {
		...
		QuraanListView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View view,
				...
				Intent intent = new Intent(ChapterListActivity.this,
						QuranDescriptionActivity.class);
				intent.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				intent.putExtra("pageNumber", quranList.get(position)
						.getPageNum());
	...
	public class QuranDataTask extends AsyncTask<Void, Void, Object> {
		...
		protected Object doInBackground(Void... arg0) {
			QuranDAO quranDAO = new QuranDAO(ChapterListActivity.this, 1);
			quranDAO.open();
			quranList = quranDAO.getQuranJuze("juzTable", "id", "name",
					"pagenumber");
			quranDAO.close();
			return null;
		}
		...
		protected void onPostExecute(Object result) {
			...
			if (quranList.size() != 0) {
				for (int i = 0; i < quranList.size(); i++) {
					mainList.add(quranList.get(i).getId() + " "
							+ quranList.get(i).getName());
				}
				adapter = new QuraanListAdapter(ChapterListActivity.this,
						quranList, Params.Quraan.JUZE_SECTION);
