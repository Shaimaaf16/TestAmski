...
public class SeriesModel extends MarkerModel implements Serializable{

	/**
	 * 
	 */
	private static final long serialVersionUID = 8154405508230233375L;
	@JsonProperty("id")
	String id;
	@JsonProperty("name")
	String name;
...
//	}
	...
	public static SeriesModel FromJson(String jsonText) {
		ObjectMapper mapper = new ObjectMapper();
		SeriesModel seriesData = null;
		try {
			seriesData = mapper.readValue(jsonText, SeriesModel.class);
			// display to console
